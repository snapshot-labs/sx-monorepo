...
<template>
  ...
  <template v-else>
    <div class="p-4 space-x-2 flex">
      ...
      >
        <UiButton pill @click="modalOpen.walletConnectLink = true">
          <svg
      ...
      <UiTooltip title="Copy address">
        <UiButton pill @click="copy(treasury.wallet)">
      ...
      >
        <UiButton pill @click="openModal(page)">
        ...
        <div v-else-if="page === 'tokens'">
          ...
          >
            <div class="flex-auto flex items-center min-w-0 space-x-3">
              ...
              >
                <UiButton pill @click.prevent="openModal('stake')">
