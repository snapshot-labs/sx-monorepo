...
import { Draft, SpaceMetadataLabel } from '@/types';
...
<template>
  <div class="flex justify-between">
    ...
    <button type="button" class="h-0" @click="labelSelectorOpen = true">
      <IH-pencil />
    </button>
  </div>
  <div
    v-if="labelSelectorOpen"
    ref="labelSelector"
  ...
  <div v-else-if="selectedLabels.length">
