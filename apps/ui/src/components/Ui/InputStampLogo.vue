  ...
  <div>
    ...
    >
      <img
        ...
        :src="imgUrl"
        :class="[
          `w-[380px] h-[76px] object-cover group-hover:opacity-80`,
          {
      ...
      <div
        v-else
        :class="[
          `w-[380px] h-[76px] block pointer-events-none !rounded-none group-hover:opacity-80`,
          {
            'opacity-80': isUploadingImage
          }
        ]"
      ...
      >
        ...
        <IH-pencil
          v-else
          class="invisible text-skin-link group-hover:visible"
        />
      </div>
    </button>
    <input
