  ...
  <div>
    ...
    <div v-else-if="spacesStore.loaded">
      <div
        ...
        class="max-w-screen-md 2xl:max-w-screen-xl 3xl:max-w-screen-2xl mx-auto p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-3 mb-3"
      >
