...
describe('validation', () => {
  describe('addresses-with-voting-power', () => {
    ...
    it('should return true for a single valid EVM address with voting power', () => {
    ...
    it('should return true for a single valid starknet address with voting power', () => {
      const result = validator.validate({
    ...
    it('should return true for a list of addresses with voting power', () => {
      const result = validator.validate({
        whitelist: `
