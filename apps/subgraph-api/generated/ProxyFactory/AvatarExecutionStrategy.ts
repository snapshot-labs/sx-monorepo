...
export class AvatarExecutionStrategySetUp extends ethereum.Event {
  get params(): AvatarExecutionStrategySetUp__Params {
    return new AvatarExecutionStrategySetUp__Params(this);
  }
}

export class AvatarExecutionStrategySetUp__Params {
  _event: AvatarExecutionStrategySetUp;

  constructor(event: AvatarExecutionStrategySetUp) {
    this._event = event;
  }
...
export class AvatarExecutionStrategy__getProposalStatusInputProposalStruct extends ethereum.Tuple {
  get author(): Address {
...
export class AvatarExecutionStrategy extends ethereum.SmartContract {
  static bind(address: Address): AvatarExecutionStrategy {
    return new AvatarExecutionStrategy("AvatarExecutionStrategy", address);
  }

  getProposalStatus(
    proposal: AvatarExecutionStrategy__getProposalStatusInputProposalStruct,
    votesFor: BigInt,
    votesAgainst: BigInt,
    votesAbstain: BigInt,
  ): i32 {
