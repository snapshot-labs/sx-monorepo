...
How to decide:
- Read the options and take their meaning from their words, not their number. Spaces word them differently: For and Against, Yes and No, Support and Reject, one option per candidate, or several options that all reject the proposal for different reasons. "Abstain" means taking no side.
...
Answer with:
- "choice": the number of one option, taken from the <options> of the proposal.
