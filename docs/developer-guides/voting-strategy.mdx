---
title: "Create a voting strategy"
...
Provide an example for the custom strategy setup which will be displayed on https://snapshot.box on the strategy's details page.
...
After the PR has been merged, you will need to wait for the release of a new version of [Snapshot](https://snapshot.box) which can take a couple of days. Once it's deployed you can move on to the next step.

### 7. Try it out!

Head to the strategy's details page and click **Playground** button. Follow the instructions from [#testing-a-voting-strategy](../user-guides/voting-strategies#testing-a-voting-strategy)to see if it works as you intended.
