---
title: "Boost"
description: "Boost is a powerful way to incentivize voting on proposals by rewarding active participation or specific actions."
---
...
1. You decide on the number of tokens you wish to commit as a reward and define the [distribution criteria](#distribution-types).
...
<Accordion title="What safeguards are in place to prevent abuse of the boosting system?">
We're actively monitoring the use of boosts and will iterate on the rules and mechanisms to prevent any form of abuse as we learn from the beta phase. There are some potential risks with [Strategic incentivization](boost), so you might want to disable this feature in your space settings.
</Accordion>
