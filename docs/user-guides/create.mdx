...
| -------------------------------- | -------------------- | ---------------------- |
| [Turbo](spaces/turbo-plan)    | 40                   | 200                    |
...
* You can combine up to **8** [voting strategies](voting-strategies). The limit also applies to multi-chain strategies. ([Turbo](spaces/turbo-plan) spaces can add up to **10** strategies)
* All testnet spaces will have the same proposal limits as a Verified space
* Can add up to **20** choices on a proposal ([Turbo](spaces/turbo-plan) spaces can add up to **1000** choices)
