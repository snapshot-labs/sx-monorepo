...
* One address can have a maximum of **20 active proposals at a time**, across multiple spaces.
...
| Unverified                       | 5                    | 10                     |
| Flagged                          | 0 — cannot create proposals | 0               |

<Info>
Learn more about Space verification and flagging in [badges-and-warnings](/user-guides/spaces/badges-and-warnings).
</Info>

* You can combine up to **6** [voting strategies](/user-guides/voting-strategies). The limit also applies to multi-chain strategies. ([Pro](/user-guides/spaces/pro) spaces can add up to **10** strategies)
* All testnet spaces will have the same proposal limits as a Verified space
* Can add up to **10** choices on a proposal ([Pro](/user-guides/spaces/pro) spaces can add up to **1000** choices)
