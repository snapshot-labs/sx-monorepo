...
* You can combine up to **4** [voting strategies](/user-guides/voting-strategies). The limit also applies to multi-chain strategies. ([Pro](/user-guides/spaces/pro) spaces can add up to **12** strategies)
