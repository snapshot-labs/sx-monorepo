---
title: "Anti-whale"
description: "Minimize the power of large token holders and encourage your community to take part in the vote!"
---
...
You can predefine the [Voting type](#user-content-fn-1) that all proposals in your space will use. In the case of the anti-whale approach, the best solution is the Quadratic Voting type.
...
\
**Read more** [**here**](sybil-resistance-scam-and-spam-prevention)**!**
</Warning>
...
```
    ...
    Do not mistake it with the voting strategy though - a [voting strategy](../../voting-strategies) is used to calculate the **individual voting power** of a user while the voting system calculates the **outcome of the proposal**.
