---
title: "Sybil resistance, scam & spam prevention"
description: "How to avoid scams, spam and make sure that your proposal authors and voters are genuine humans? How can you take into account users' onchain reputation? Read on!"
---
...
* [Space roles](#1.-space-roles)
* [Validation Strategies](#2.-validation-strategies) (use for Proposal Creation and Voting)
* [Voting Strategies ](#3.-voting-strategies)(use for Voting Validation)

## 1. Space roles

Let’s first recap what are the different permissions of the [roles](../space-roles) defined in the **Members** tab of the Space settings:
