...
[Validation Strategies](../../validation-strategies) are a way to define who is allowed to vote on a proposal or create a new one. 

[Voting Strategies](../../voting-strategies) calculate how much Voting Power each user has.
...
Select the [**Basic Voting Validation**](../../validation-strategies#validation-strategy-example-basic)**.**
...
Select the [**Gitcoin Passport Validation**](../../validation-strategies#validation-strategy-example-gitcoin-passport).
