...
description: "If none of the above scenarios work for your use case, you can use the customizable Strategies to leverage your own custom calculation mechanisms. Read on to learn more!"
---
...
\
Have a look at the [Broken link](broken-reference) section of this documentation to learn more!
</Info>

### [api-v2](https://snapshot.org/#/strategy/api-v2)

This strategy allows offchain data to be used as Voting Power through calling a custom API endpoint to request the score for a set of addresses.
