...
description: "Include tokens added in liquidity pools or staking contracts into Voting Power calculation besides those held in users' wallets."
---
...
[https://snapshot.org/#/playground/uniswap?query=eyJwYXJhbXMiOnsiYWRkcmVzcyI6IjB4NmIxNzU0NzRlODkwOTRjNDRkYTk4Yjk1NGVlZGVhYzQ5NTI3MWQwZiIsInN5bWJvbCI6IkRBSSJ9LCJuZXR3b3JrIjoiMSIsInNuYXBzaG90IjoiIiwiYWRkcmVzc2VzIjpbIjB4NzkzMTdmYzBmYjE3YmMwY2UyMTNhMmI1MGYzNDNlNGQ0YzI3NzcwNCJdfQ..](https://snapshot.org/#/playground/uniswap?query=eyJwYXJhbXMiOnsiYWRkcmVzcyI6IjB4NmIxNzU0NzRlODkwOTRjNDRkYTk4Yjk1NGVlZGVhYzQ5NTI3MWQwZiIsInN5bWJvbCI6IkRBSSJ9LCJuZXR3b3JrIjoiMSIsInNuYXBzaG90IjoiIiwiYWRkcmVzc2VzIjpbIjB4NzkzMTdmYzBmYjE3YmMwY2UyMTNhMmI1MGYzNDNlNGQ0YzI3NzcwNCJdfQ..)
...
In comparison with [v2](#uniswap), **Uniswap v3** provides users with the most flexibility and granular control over personal assets by introducing features like concentrated liquidity and multiple LP fee tiers per pair — 0.05%, 0.30%, and 1.00%.
