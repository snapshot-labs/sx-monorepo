...
<Info>
If you would like to get your space verified, head to [get verified](/user-guides/spaces/get-verified) and follow the guide.
</Info>
...
<table><thead><tr><th width="115">Badge</th><th>Label</th><th>Description</th></tr></thead><tbody><tr><td>![](/images/198.png)</td><td>Pro space</td><td>Verified space with Pro plan</td></tr><tr><td>![](/images/45.png)</td><td>Verified</td><td>Manually curated by Snapshot Labs to identify spaces that passed the verification criteria.</td></tr><tr><td>![](/images/49.png)</td><td>Warning</td><td>Manually curated by Snapshot Labs to identify spaces that impersonate a project, infringe IP, or spaces that are proven to be scams.</td></tr></tbody></table>

<Info>
Voting on a proposal which belongs to a space flagged with the warning badge **is not dangerous** as the vote does not trigger a transaction - your account and assets are safe.
</Info>
