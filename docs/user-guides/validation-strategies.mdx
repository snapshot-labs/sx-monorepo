...
<Warning>
Only use this option with non-transferable tokens. With a transferable token, the same token could be moved between wallets to pass validation multiple times.
</Warning>
