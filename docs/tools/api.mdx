---
title: "API"
description: "You can use the Hub GraphQL API to create flexible queries for the data you need to integrate with Snapshot."
---

<Info>
There is a limit of 60 requests per minute with the API, to get higher limits please apply for an API Key by following this guide: [api-keys.md](api-keys)
</Info>
