---
title: "Snapshot.js"
description: "The official JavaScript client for implementing Snapshot's functionality in other apps."
---
...
[**Snapshot.js Repository**](https://github.com/snapshot-labs/snapshot.js)
...
<Info>
The below methods are sending a request to Score API. Same as [Hub API](/tools/api) it requires an API Key for **higher usage limits**. You can see we require it for the **`apiKey`** variable.

If you already have an API Key for Hub API, you can reuse it for Score. In case you don't have an API Key, follow the instructions here: [API keys](/tools/api/api-keys)
</Info>
