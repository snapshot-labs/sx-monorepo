...
We hope that the flexibility of the system will unlock a new era of programmable onchain governance. The interface of a strategy can be found [here](https://github.com/snapshot-labs/sx-evm/blob/main/src/interfaces/IVotingStrategy.sol).
