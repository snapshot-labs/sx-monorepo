...
<Tip>
This approach unlocks **optimistic governance mechanisms** where proposals are assumed to be accepted unless DAO members choose otherwise by voting against. This can lead to a far higher level of governance efficiency as it reduces the number of onchain transactions for 'non-controversial' proposals. 
</Tip>
