export type ExecutorType = 'SimpleQuorumVanilla' | 'SimpleQuorumAvatar' | 'SimpleQuorumTimelock' | 'EthRelayer';
...
export type NetworkConfig = {
    ...
    authenticators: {
        [key: string]: VanillaAuthenticatorConfig | EthTxAuthenticatorConfig | EthSigAuthenticatorConfig | StarkSigAuthenticatorConfig | StarkTxAuthenticatorConfig | undefined;
    };
    strategies: {
        [key: string]: VanillaStrategyConfig | CompStrategyConfig | OzVotesStrategyConfig | Erc20VotesStrategyConfig | WhitelistStrategyConfig | SingleSlotProofStrategyConfig | undefined;
    };
};
export type EvmNetworkConfig = Omit<NetworkConfig, 'eip712ChainId' | 'spaceFactory' | 'starknetCommit'> & {
