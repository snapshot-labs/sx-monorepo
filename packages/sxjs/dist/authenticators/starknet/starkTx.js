...
const StarkTxAuthenticator_json_1 = __importDefault(require("./abis/StarkTxAuthenticator.json"));
const starknet_enums_1 = require("../../utils/starknet-enums");
const callData = new starknet_1.CallData(StarkTxAuthenticator_json_1.default);
function createStarkTxAuthenticator() {
    return {
        type: 'starkTx',
...
exports.default = createStarkTxAuthenticator;
