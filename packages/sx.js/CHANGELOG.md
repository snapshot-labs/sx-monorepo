...
- cb368c0: Use the decoded transfer recipient for ERC-20 sendToken executions instead of the token contract
- 1681c74: Add basesep SnapshotX contracts
...
- 7c2bd7a: Remove the Highlight client (`HighlightEthereumSigClient`), `HIGHLIGHT_DOMAIN`, the Townhall constants and the `Receipt` type
